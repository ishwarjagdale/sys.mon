        ...
        <>
            <div className={"w-full lg:max-w-[50%] p-4 md:p-8 lg:p-4 flex-col items-center backdrop-blur-[4px]"}>
                ...
                <div className={"mt-2 lg:mt-6 lg:flex"}>
                    ...
                    <Button children={"Watch Demo"} classList={"hidden lg:block font-bold mx-1 hover:bg-gray-200"}/>
                </div>
                <div className={"flex-col mt-2 lg:mt-12 md:mt-[40px] flex items-center lg:items-start mx-1 text-lg"}>
                    ...
                    <ul className={"flex font-bold text-[16px]"}>
                        <li className={"mr-[10px] mt-[10px] flex items-center"}><span
                            className={"fab fa-windows mr-2 flex items-center"}/><span className={"hidden lg:block"}>Windows</span></li>
                        <li className={"mr-[10px] mt-[10px] flex items-center"}><span
                            className={"fab fa-apple mr-2"}/><span className={"hidden lg:block"}>Mac</span></li>
                        <li className={"mr-[10px] mt-[10px] flex items-center"}><span
                            className={"fab fa-linux mr-2"}/><span className={"hidden lg:block"}>Linux</span></li>
                    </ul>
                </div>
            </div>
            <img id={"heroImage"} src={heroImage} className={"md:max-w-[50%] px-4"} alt={"process"} title={"Designed by slidesgo / Freepik"}/>
        </>
    )
}
